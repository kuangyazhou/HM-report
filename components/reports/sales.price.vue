              ...
              <div class="flex note column center" :style="{width:'180px'}">
                ...
                <span class="flex center column">
                  ...
                  <span class="flex text-total center">
                    <span>{{fiveTotal}}</span>
                    <span class="text-gray">(均值
                      <span class="text-yellow">{{fiveAvg}}</span>)</span>
                  </span>
                </span>
                <span class="flex center column">
                  ...
                  <span class="flex text-total center">
                    <span>{{tenTotal}}</span>
                    <span class="text-gray">(均值
                      <span class="text-yellow">{{tenAvg}}</span>)</span>
                  </span>
                </span>
                <span class="flex center column">
                  ...
                  <span class="flex text-total center">
                    ...
                    <span class="text-gray">(均值
                      <span class="text-yellow">{{thousandAvg}}</span>)</span>
                  </span>
                </span>
              </div>
...
export default {
  ...
  methods: {
    ...
    lastMonth(e) {
      ...
      // let startDateForSql=new Date().Format('yyyyMM')+'01';
